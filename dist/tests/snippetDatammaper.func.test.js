...
describe('Tests fonctionnels Snippets', () => {
    ...
    beforeAll(async () => {
        ...
        const res = await client.query('INSERT INTO "user" (first_name, last_name, email, password, role) VALUES ($1,$2,$3,$4,$5) RETURNING id', [testUser.first_name, testUser.last_name, testUser.email, hashedPassword, 'member']);
